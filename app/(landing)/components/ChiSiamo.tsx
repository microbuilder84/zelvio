export default function ChiSiamo() {
    return (
        <section id="chi-siamo" className="py-20 md:py-28 bg-white">
            <div
                className="max-w-3xl mx-auto px-6 text-center md:text-left
            ...
            >
                ...
                <p
                    className="mt-6 md:mt-8 max-w-md md:max-w-xl mx-auto md:mx-0
                ...
                <p
                    className="mt-5 md:mt-6 max-w-md md:max-w-xl mx-auto md:mx-0
                               text-[15px] md:text-base text-gray-600 leading-[1.65]"
                >
