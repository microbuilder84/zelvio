    ...
    return (
        <section id="perche-zelvio" className="py-20 md:py-28 bg-gray-50">
            <div className="max-w-3xl mx-auto px-6 text-center md:text-left">
                ...
                <p className="mt-3 max-w-md mx-auto text-[15px] md:text-base text-gray-600 leading-relaxed text-center md:text-left">
                ...
                <div className="mt-14 grid md:grid-cols-2 gap-8 md:gap-16">
                    ...
                    {/* Benefit 1 */}
                    <div className="p-5 md:p-6 rounded-xl border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:bg-white cursor-default">
