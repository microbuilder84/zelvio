    ...
    return (
        <header className="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-200 z-50">
            <nav className="max-w-5xl mx-auto px-8 h-16 flex items-center justify-between">
                ...
                <a
                    href="/"
                    className="text-xl font-semibold text-gray-900 tracking-tight pr-10"
                >
                    Zelvio
                </a>
                ...
                <div className="hidden md:flex items-center gap-6 pl-10">
                    ...
                    <a
                        href="/registrati"
                        className="px-2 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm"
                    >
                        Registrati
                    </a>
                </div>
                ...
                {/* WRAPPER PER OVERLAY + MENU MOBILE (Punto 2) */}
                {isOpen && (
                    <div
                    ...
                    >
                        {/* Pannello laterale */}
                        <div
                            className="absolute right-0 top-0 h-full w-[75%] max-w-[320px] bg-white shadow-xl p-6 flex flex-col gap-6 animate-slideIn"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <a href="#come-funziona" className="text-lg font-medium text-gray-800">
                                Come funziona
                            </a>

                            <a href="#perche-zelvio" className="text-lg font-medium text-gray-800">
                                Perché Zelvio
                            </a>

                            <a href="#chi-siamo" className="text-lg font-medium text-gray-800">
                                Chi siamo
                            </a>

                            <a href="#contatti" className="text-lg font-medium text-gray-800">
                                Contatti
                            </a>
